...
// Bir değişken değiştiğinde useState component’in tekrar render olmasını tetikler useRef 
// component’in tekrar render olmasını tetiklemez.
...
// useRef ile oluşturulan bir ref sadece component oluştuğunda (onMount) oluşturulur
// ve tüm lifecycle’ı boyunca korunur.Bir ref’i güncellemek “side effect” oluşturacağı için 
// sadece useEffect, useLayoutEffect veya bir event handler içerisinde güncellenmelidir.